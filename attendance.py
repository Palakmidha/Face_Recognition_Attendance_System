...
class Attendance:
    def __init__(self,root):
        ...
        # First Image
        img=Image.open(r"images\Pic22.png")
        img=img.resize((750,180),Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(img)

        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=750,height=180)

       
        #Second Image 
        img1=Image.open(r"images\Pic23.jpg")
        img1=img1.resize((750,180),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=750,y=0,width=750,height=180)
        ...
        main_frame.place(x=5,y=60,width=1350,height=510)

        # Left Frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=630,height=500)

        img_left=Image.open(r"images\Pic24.jpg")
        ...
        left_inside_frame.place(x=0,y=135,width=625,height=300)
    ...
    # Labels and Entry
        ...
        btn_frame.place(x=0,y=250,width=612,height=35)

        save_btn=Button(btn_frame,text="Import CSV",command=self.importCsv,width=16,font=("times new roman",12,"bold"),bg="#1D5C63",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Export CSV",command=self.exportCsv,width=16,font=("times new roman",12,"bold"),bg="#1D5C63",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Update",width=16,font=("times new roman",12,"bold"),bg="#1D5C63",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",width=16,command=self.reset_data,font=("times new roman",12,"bold"),bg="#1D5C63",fg="white")
        ...
        Right_frame.place(x=660,y=10,width=665,height=490)

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=650,height=450)
