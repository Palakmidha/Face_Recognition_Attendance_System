...
class Student:
    def __init__(self,root):
        ...
        # First Image
        img=Image.open(r"images\Pic13.jpg")
        ...
        #Second Image 
        img1=Image.open(r"images\Pic15.jpg")
        img1=img1.resize((500,130),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=480,y=0,width=500,height=130)


        # Third Image  
        img2=Image.open(r"images\Pic16.jpg")
        ...
        title_lbl=Label(bg_img,text="Management System",font=("times new roman",32,"bold"),bg="#97C4B8",fg="black")
        ...
        # Left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=630,height=490)

        img_left=Image.open(r"images\Pic14.jpg")
        ...
        # Current degree
        current_course_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=14,y=160,width=620,height=125)
        ...
        dep_combo["values"]=("Select Department","Computer Science","Information Technology","Electronics and Communication","Civil","Mechanical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","Btech","Mtech","BE")
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",13,"bold"),state="read only",width=20)
        course_combo["values"]=("Select Year","2020-2021","2021-2022","2022-2023","2023-2024")
        course_combo.current(0)
        ...
        semester_combo["values"]=("Select Course","Semester-1","Semester-2","Semester-3","Semester-4","Semester-5","Semester-6","Semester-7","Semester=8")
        ...
        class_student_frame.place(x=15,y=290,width=620,height=205)
        ...
        # class_div_entry.grid(row=1,column=1,padx=10,pady=3,sticky=W)

        division_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",13,"bold"),state="read only",width=18)
        division_combo["values"]=("Select ","A","B","C")
        division_combo.current(0)
        division_combo.grid(row=1,column=1,padx=10,pady=3,sticky=W)

        # Roll no.
        roll_no_label=Label(class_student_frame,text="Roll No:",font=("times new roman",13,"bold"),bg="white")
        roll_no_label.grid(row=1,column=2,padx=10,pady=3,sticky=W)
        ...
        phone_no_label.grid(row=3,column=2,padx=10,pady=3,sticky=W)

        phone_no_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=15,font=("times new roman",13,"bold"))
        phone_no_entry.grid(row=3,column=3,padx=10,pady=3,sticky=W)
        ...
        btn_frame1.place(x=3,y=140,width=612,height=30)

        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=45,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=45,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        update_photo_btn.grid(row=0,column=1)


        btn_frame=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame.place(x=3,y=160,width=612,height=30)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=20,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=21,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=21,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=21,font=("times new roman",10,"bold"),bg="#1D5C63",fg="white")
        reset_btn.grid(row=0,column=3)
        
        
     # Right label frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=660,y=10,width=665,height=480)

        img_right=Image.open(r"images\Pic17.png")
        ...
        search_label=Label(search_frame,text="Search By:",font=("times new roman",13,"bold"),bg="#417D7A")
        ...
        search_btn=Button(search_frame,text="Search",width=11,font=("times new roman",11,"bold"),bg="#1D5C63",fg="white")
        search_btn.grid(row=0,column=3,padx=4)

        showAll_btn=Button(search_frame,text="Show All",width=11,font=("times new roman",11,"bold"),bg="#1D5C63",fg="white")
        showAll_btn.grid(row=0,column=4,padx=4)

       # Table frame
        table_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=175,width=650,height=280)

        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","semester","id","name","class","roll no","gender","dob","phone no","address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="palak",database="face_recognition")
...
######Generate dataset or take photo samples
    ...
    ######### Load prdefined data on face frontals fron Open cv
